        ...
        return (
            ...
            >
                ...
                <div className='checkbox-outer' style={{ color: this.props.color || this.props.theme.primary }}>
                    <div className='checkbox-inner' style={Object.assign(checkboxInner, { background: this.props.color || this.props.theme.primary })}>
                        <div className='checkbox-hide' style={Object.assign(checkboxHide, { background: this.props.color || this.props.theme.primary })} />
                        <svg viewBox="0 0 500 500" className='checkbox-svg' style={{ fill: this.props.vColor || this.props.theme.secondary }}>
