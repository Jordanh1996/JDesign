...
class Select extends React.Component {
    ...
    render() {
        ...
        return (
            <div className='floatingSelect-container' tabIndex='0' onBlur={this.closeOptions} disabled={this.props.disabled}>
                ...
                >
                    {text}
                    <svg viewBox="0 0 255 255" className='floatingSelect-icon'>
